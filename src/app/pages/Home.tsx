      ...
      <section id="partners" className="py-12 md:py-24 px-6" style={{ backgroundColor: '#f9fafb' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-3xl mx-auto">
            <PartnerLogo name="GenWise" url="https://genwise.in" logoUrl="/images/partners/genwise.png" />
            <PartnerLogo name="Godrej Foundation" url="https://www.godrejfoundation.com" logoUrl="/images/partners/godrej-foundation.svg" />
          </div>
        </div>
      </section>
